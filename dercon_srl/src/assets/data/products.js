export const products = [
  {
    id: 1,
    category: "hormigon",
    title: 'Bateas de Hormigón Armado',
    text: `Componente estructural de elaboración propia muy versátil
                    y ampliamente utilizado en la construcción debido a sus
                    propiedades de resistencia, durabilidad y capacidad para
                    soportar cargas pesadas.

                    Empleabilidad: Fundaciones, cimentaciones, sistemas de
                    drenaje, canales o como base estructural
                  
                     Medidas: 2,15mt largo`,
    src: "/img/products/bateas.jpg",
    alt: "Bateas de Hormigon"
  },
  {
    id: 2,
    category: "arena",
    title: 'Arena',
    text: ` Ofrecemos arena en bolsones de 1m³, 1/2m³ y a granel. 

                     Consultanos disponibilidad y precios`,
  ...
  },
  {
    ...
    category: "piedra",
    title: 'Piedra 6-19',
    text: ` Ofrecemos piedra 6-19 en bolsones de 1m³, 1/2m³ y a granel. 

                     Consultanos disponibilidad y precios`,
    src: "/img/products/piedra..jpg",
    alt: "Piedra en bolson"
  },
  {
    id: 4,
    category: "ladrillos",
    title: 'Ladrillo Macizos',
    text: ` Ladrillo denso y compacto, sin perforaciones o con muy
                    pocas, lo que lo convierte en una opción robusta y
                    resistente.


                     Formas de venta: Pallets de 200 unidades (envio gratis) o
                    unitario`,
    src: "/img/products/ladrillo-macizo.jpg",
    alt: "Ladrillo Macizo"
  },
  {
    id: 5,
    category: "hormigon",
    title: 'Tubos de Hormigón Armado',
    text: `  Productos de elaboración propia

                   
                    Empleabilidad: Sistema de drenaje plubial, redes de
                    alcatarillado, canalizacion de ríos y cauces de agua, etc.
                    
                    Medidas: 40, 60, 80, 100 y 120 cm de diametro.
                   
                    Consultanos disponibilidad en medidas`,
    src: "/img/products/tubos2.jpeg",
    alt: "Tubos de Hormigon"
  },

  {
    ...
    category: "piedra",
    title: 'Binder',
    text: `  El binder es esencial para garantizar la estabilidad,
                    durabilidad y resistencia de pavimentos y mezclas de
                    concreto, ya que actúa como el material que une los
                    componentes, evitando el desgaste prematuro y mejorando la
                    vida útil de las infraestructuras.`,
    src: "/img/products/binder.jpeg",
    alt: "Binder"
  },
  {
    id: 7,
    category: "ladrillos",
    title: 'Ladrillo Cerámico',
    text: ` Está fabricado con arcilla cocida y presenta una
                    estructura con celdas o perforaciones que le otorgan un
                    peso más ligero
                    

                    Formas de venta: Pallets de 200 unidades (envio gratis) o
                    unitario`,
    src: "/img/products/ladrillo-hueco.jpg",
    alt: "Ladrillo Cerámico"
  },
  {
    id: 8,
    category: "hormigon",
    title: 'Comederos de Hormigón',
    text: ` ¿Buscas contenedores de líquidos o sólidos para ganado?
                    Estás en el lugar indicado. Consultanos precios,
                    disponibilidad y hasta incluso presupuesto para
                    fabricación personalizada.`,
    src: "/img/products/bateas2.jpeg",
    alt: "Comederos de Hormigón"
  },
  {
    id: 9,
    category: "aglomerantes",
    title: 'Cemento',
    text: ` Material esencial en la construcción, con un amplio rango
                    de aplicaciones.
                  
                    Formas de venta: Pallets de 200 unidades (envio gratis) o
                    unitario`,
    src: "/img/products/cemento.jpeg",
    alt: "Cemento"
  },
  {
    id: 10,
    category: "aglomerantes",
    title: 'Cal',
    text: `Material versátil y ampliamente utilizado en la
                    construcción debido a sus propiedades aglomerantes, su
                    capacidad de mejorar la calidad de los morteros y su
                    utilidad en diferentes aplicaciones, desde el tratamiento
                    de suelos hasta la restauración de edificios.
                    
                    Formas de venta: Unitario`,
    src: "/img/products/cemento.jpeg",
    alt: "Cal"
  },
  {
    ...
    category: "aglomerantes",
    title: 'Plasticor',
    text: ` Aditivo utilizado en la mezcla de morteros para mejorar
                    sus propiedades de trabajabilidad y durabilidad.
